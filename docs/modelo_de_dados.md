...
| _Rate limit_                    | Redis            | Volátil            | Contadores efêmeros                                   |
...
Motivos: (a) a base de cartas do MTG tem 25.000+ _oracle cards_ e 90.000+ _printings_, e cresce a cada
...
| Conta excluída     | _Soft delete_ imediato; expurgo físico em **30 dias** | `RF13`, LGPD art. 18  |
...
- _Access/refresh token_ de provedor OAuth.
...
| Item                 | Política                                                          |
| -------------------- | ----------------------------------------------------------------- |
| _Full backup_        | Diário, retenção de 30 dias                                       |
