...
| Padrões de projeto aplicados no game-server                                          | [padroes_command_e_template_method.md](padroes_command_e_template_method.md)                           | [documento_de_arquitetura.md](documento_de_arquitetura.md)                                             |
...
| `DOC-097` | [padroes_command_e_template_method.md](padroes_command_e_template_method.md)         | Command no desfazer da mesa, e Template Method na família de ações ao acaso.                | Estável |
| `DOC-099` | [guia_rapido_command_e_template_method.md](guia_rapido_command_e_template_method.md) | Versão curta do DOC-097: o que cada padrão resolve, com um exemplo de cada.                 | Estável |
