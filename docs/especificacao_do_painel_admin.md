...
- A interface permite que o Administrador preencha o formulário para lançar novos *Playmats* e *Sleeves* pré-definidos no sistema.
...
| Funcionalidade | Descrição |
|---|---|
| **Forçar Cache da Scryfall** | Aciona manualmente o *Worker* que faz o bulk download de todos os dados do MTG na Scryfall (útil após o fim dos spoilers de uma nova coleção). |
