...
**Premissa que atravessa todo o documento:** o sistema é *sandbox*. Nenhum requisito aqui implica
...
| **RF18** | O jogador deve poder operar o grimório: comprar 1, comprar X, embaralhar, olhar o topo, mover para o fundo, *mill*. | **M** | MVP | Embaralhar e comprar são resolvidos no servidor; log registra a ação. |
...
| **RF11** | Chat de voz com supressão de ruído e modo *Voice Activity* ou *Push-to-Talk*. | **M** | V1 | 4 participantes com áudio inteligível; indicador de "falando"; mute local por jogador. |
| **RF22** | O sistema deve oferecer *ping* visual na mesa para chamar atenção a um ponto ou carta. | **C** | V1 | Ping aparece para todos com decaimento em ~2 s. |
...
| **RNF02** | Escalabilidade | Rede deve suportar adição horizontal de nós de WebSocket com *load balancing* | Dobrar CCU dobrando instâncias, sem alteração de código |
